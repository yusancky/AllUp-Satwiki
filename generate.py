...
def make(id):
    match id:
        ...
        case '1':
            ...
            return AllUp_utils.wikitext.switch(data)
        case '2':
...
if __name__ == '__main__':
    ...
    AllUp_content = f"<includeonly>{AllUp_utils.wikitext.switch(AllUp_data)}</includeonly><noinclude>[[Category:模板]]{{{{documentation}}}}</noinclude>"
